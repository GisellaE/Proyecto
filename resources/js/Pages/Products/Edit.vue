      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
          ...
          <div class="hidden md:flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span class="text-gray-900">Editar: {{ product.name }}</span>
          </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
            ...
            <p class="text-blue-100 mt-2">Actualiza los datos de "{{ product.name }}"</p>
          </div>
          ...
          <form @submit.prevent="submit" class="p-8">
              ...
              <div class="space-y-6">
                ...
                <div v-if="product.image">
                  ...
                  <div class="relative inline-block">
                    <img 
                      ...
                      :alt="product.name"
                      class="w-full max-w-xs h-48 object-cover rounded-xl shadow-md"
                    />
                ...
                <div>
                  ...
                  <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-500 transition-colors">
                    ...
                    <div v-if="!imagePreview" @click="$refs.imageInput.click()" class="cursor-pointer">
                      ...
                      <p class="text-gray-600 mb-2">Haz clic para {{ product.image ? 'cambiar' : 'subir' }} imagen</p>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div class="flex items-center space-x-2 text-blue-800 mb-3">
                    ...
                    <span class="font-medium">Información del producto</span>
                  </div>
                  <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                      ...
                      <span class="text-gray-600">{{ product.category?.name || 'Sin categoría' }}</span>
                    </div>
                    <div class="flex justify-between">
            ...
            <div class="pt-6 border-t border-gray-200 mt-6">
              <button
                type="button"
                @click="confirmDelete"
                class="bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition-colors flex items-center space-x-2 text-sm"
              >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const confirmDelete = () => {
  if (confirm(`¿Estás seguro de que quieres eliminar el producto "${props.product.name}"? Esta acción no se puede deshacer.`)) {
    router.delete(route('products.destroy', props.product.slug))
  }
}
